        ...
        >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              ...
              <p>
                {language === 'ru'
                  ? 'Стоимость госпошлины за оформление миграционного учета - 500 рублей для граждан из визовых стран, студентов с РВП, РВПО и ВНЖ, а также граждан Республики Беларусь.'
                  : 'The state fee for migration registration is 500 rubles for citizens from visa countries, students with RVP, RVPO and VNZh, as well as citizens of the Republic of Belarus.'
                }
              </p>
              
              <p>
                {language === 'ru'
                  ? 'Стоимость временной регистрации для граждан из безвизовых стран - 1500 рублей. Сюда входят граждане Абхазии, Азербайджана, Армении, Казахстана, Киргизии, Молдовы, Таджикистана, Узбекистана.'
                  : 'The cost of temporary registration for citizens from visa-free countries is 1500 rubles. This includes citizens of Abkhazia, Azerbaijan, Armenia, Kazakhstan, Kyrgyzstan, Moldova, Tajikistan, Uzbekistan.'
                }
              </p>
